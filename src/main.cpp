...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
	...
	if (pindexBest->nHeight == 1)
        ...
        nSubsidy = 1 * COIN;	 // 50,000 OYON for instamine prevention
	else if (pindexBest->nHeight <= 1000000) // 298,500,000 OYON
		nSubsidy = 300 * COIN;	
	else if (pindexBest->nHeight <= 2000000) // 200,000,000 OYON
		nSubsidy = 200 * COIN;
	else if (pindexBest->nHeight <= 3000000) // 100,000,000 OYON
		nSubsidy = 100 * COIN;		
    else if (pindexBest->nHeight > LAST_POW_BLOCK) // Block 3m
		nSubsidy = 0; // PoW Ends ~ 660,000,000 Total OYON Mined via PoW
