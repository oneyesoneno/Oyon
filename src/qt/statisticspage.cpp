...
void StatisticsPage::updateStatistics()
{
    ...
    {
        subsidy = "300 OYON per block";
    }
	else if (pindexBest->nHeight < 2000000)
    {
        subsidy = "200 OYON per block";
    }
	else if (pindexBest->nHeight < 3000000)
    {
        subsidy = "100 OYON per block";
    }
    else if (pindexBest->nHeight > 3000000)
    {
        subsidy = "Full PoS";
    ...
    {
        ui->volumeBox->setText("<b><font color=\"yellow\">" + qVolume + " OYON" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " OYON" + "</font></b>");
    } else {
        ui->volumeBox->setText("<b><font color=\"orange\">" + qVolume + " OYON" + "</font></b>");
    }
