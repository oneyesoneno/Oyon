// Copyright (c) 2014 The Oyoncoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("oyoncoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("oyoncoin-smsg-pow"); // Make this thread recognisable
